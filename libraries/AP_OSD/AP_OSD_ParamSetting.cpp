...
static const char* SERVO_FUNCTIONS[] = {
    "NONE", "RCPASS", "FLAP", "FLAP_AUTO", "AIL", "", "MNT_PAN", "MNT_TLT", "MNT_RLL", "MNT_OPEN", "CAM_TRG", "", "MNT2_PAN",
    "MNT2_TLT", "MNT2_RLL", "MNT2_OPEN", "DIF_SPL_L1", "DIF_SPL_R1", "", "ELE", "", "RUD", "SPR_PMP", "SPR_SPIN", "FLPRON_L",
    "FLPRON_R", "GRND_STEER", "PARACHT", "GRIP", "GEAR", "ENG_RUN_EN", "HELI_RSC", "HELI_TAIL_RSC", "MOT_1", "MOT_2",
    "MOT_3", "MOT_4", "MOT_5", "MOT_6", "MOT_7", "MOT_8", "MOT_TLT", "", "", "", "", "", "", "", "", "", "RCIN_1", "RCIN_2",
    "RCIN_3", "RCIN_4", "RCIN_5", "RCIN_6", "RCIN_7", "RCIN_8", "RCIN_9", "RCIN_10", "RCIN_11", "RCIN_12", "RCIN_13", "RCIN_14",
    "RCIN_15", "RCIN_16", "IGN", "", "START", "THR", "TRCK_YAW", "TRCK_PIT", "THR_L", "THR_R", "TLTMOT_L", "TLTMOT_R", "ELEVN_L", "ELEVN_R",
    "VTAIL_L", "VTAIL_R", "BOOST_THR", "MOT_9", "MOT_10", "MOT_11", "MOT_12", "DIF_SPL_L2", "DIF_SPL_R2", "", "MAIN_SAIL",
    ...
    "", "", "", "", "", "", "", "", "", "", "NEOPX_1", "NEOPX_2", "NEOPX_3", "NEOPX_4", "RAT_RLL", "RAT_PIT","RAT_THRST", "RAT_YAW",
    "WSAIL_EL", "PRLED_1", "PRLED_2", "PRLED_3", "PRLED_CLK"
};
...
const AP_OSD_ParamSetting::ParamMetadata AP_OSD_ParamSetting::_param_metadata[] = {
    ...
    { PARAM_INDEX(150, 0, 20550), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO1_FUNCTION
    { PARAM_INDEX(150, 0, 20614), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO2_FUNCTION
    { PARAM_INDEX(150, 0, 20678), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO3_FUNCTION
    { PARAM_INDEX(150, 0, 20742), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO4_FUNCTION
    { PARAM_INDEX(150, 0, 20806), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO5_FUNCTION
    { PARAM_INDEX(150, 0, 20870), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO6_FUNCTION
    { PARAM_INDEX(150, 0, 20934), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO7_FUNCTION
    { PARAM_INDEX(150, 0, 20998), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO8_FUNCTION
    { PARAM_INDEX(150, 0, 21062), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO9_FUNCTION
    { PARAM_INDEX(150, 0, 21126), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO10_FUNCTION
    { PARAM_INDEX(150, 0, 21190), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO11_FUNCTION
    { PARAM_INDEX(150, 0, 21254), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO12_FUNCTION
    { PARAM_INDEX(150, 0, 21318), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO13_FUNCTION
    { PARAM_INDEX(150, 0, 21382), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO14_FUNCTION
    { PARAM_INDEX(150, 0, 21446), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO15_FUNCTION
    { PARAM_INDEX(150, 0, 21510), 0, 132, 1, ParamMetadata::StringValues, ARRAY_SIZE(SERVO_FUNCTIONS), SERVO_FUNCTIONS }, // SERVO16_FUNCTION

    { PARAM_INDEX(150, 0, 24647), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC1_OPTION
    { PARAM_INDEX(150, 0, 24711), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC2_OPTION
    { PARAM_INDEX(150, 0, 24775), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC3_OPTION
    { PARAM_INDEX(150, 0, 24839), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC4_OPTION
    { PARAM_INDEX(150, 0, 24903), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC5_OPTION
    { PARAM_INDEX(150, 0, 24967), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC6_OPTION
    { PARAM_INDEX(150, 0, 25031), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC7_OPTION
    { PARAM_INDEX(150, 0, 25095), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC8_OPTION
    { PARAM_INDEX(150, 0, 25159), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC9_OPTION
    { PARAM_INDEX(150, 0, 25223), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC10_OPTION
    { PARAM_INDEX(150, 0, 25287), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC11_OPTION
    { PARAM_INDEX(150, 0, 25351), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC12_OPTION
    { PARAM_INDEX(150, 0, 25415), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC13_OPTION
    { PARAM_INDEX(150, 0, 25479), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC14_OPTION
    { PARAM_INDEX(150, 0, 25543), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS },  // RC15_OPTION
    { PARAM_INDEX(150, 0, 25607), 0, 104, 1, ParamMetadata::StringValues, ARRAY_SIZE(AUX_OPTIONS), AUX_OPTIONS }   // RC16_OPTION
};
