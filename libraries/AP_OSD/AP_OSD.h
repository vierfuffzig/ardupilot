...
private:
    ...
    #if APM_BUILD_TYPE(APM_BUILD_ArduCopter) OR (CONFIG_HAL_BOARD == HAL_BOARD_SITL AND APM_BUILD_TYPE(APM_BUILD_ArduCopter))
    ...
    #elif APM_BUILD_TYPE(APM_BUILD_ArduPlane) OR (CONFIG_HAL_BOARD == HAL_BOARD_SITL AND APM_BUILD_TYPE(APM_BUILD_ArduPlane))
